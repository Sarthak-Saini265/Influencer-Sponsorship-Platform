...
let contracts_status_div = document.querySelector(".contracts_status_div");
let other_contracts_heading = document.querySelector(".other_contracts_heading");
...
contracts_btn.addEventListener("click", function () {
    ...
    contracts_status_div.style.display = "block";
    other_contracts_heading.style.display = "block";
...
dashboard_btn.addEventListener("click", function () {
    ...
    contracts_status_div.style.display = "none";
    other_contracts_heading.style.display = "none";
